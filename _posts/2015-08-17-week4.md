...
###### >checking_ShapiroW_Ecoli<-uniNorm(data_Ecoli,type = "SW",desc = T); >checking_Lillie_Ecoli<-uniNorm(data_Ecoli,type = "Lillie",desc = T)
![left](/Figs/Semana4/Ecoli/uniNorm_Ecoli_Shapiro.png)
![right](/Figs/Semana4/Ecoli/uniNorm_Ecoli_Lillie.png)

------

###### >outliers_Mahalonobis_Ecoli<-mvOutlier(data_Ecoli,qqplot = T,method = "quan"); >outliers_Adjusted_Mahalonobis_Ecoli<-mvOutlier(data_Ecoli,qqplot=T,method="adj.quan")
