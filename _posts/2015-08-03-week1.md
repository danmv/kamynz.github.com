...
3. `I have to construct a better function` but first I want to see what statistical techniques are the best to get
significant biological variables.
4. `I still have to evaluate others lengths of fragments (e.g. 1000, 5000, etc) and slide through the genomes with
overlaping windows`
